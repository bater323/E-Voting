    ...
    <?php
        ...
        <div class="page-wrapper">
          ...
          ?>
                ...
                <img class="img-circle" width="50" src="<?php echo base_url().'assetss/images/user_blank.png';?>" width="100%" >     
                                    <?php }else{
                                  ?>
                             <img src="<?php echo base_url().'assets/images/'.$c['pengguna_photo'];?>" alt="user-img" width="100%" class="img-circle">
          ...
          ?>
                            <div class="card-body">
                            <form action="<?php echo base_url() . 'admin/Pengguna/update_PROFIL' ?>" method="post" class="form-horizontal form-material" enctype="multipart/form-data">
                                        <input type="hidden" name="kode" value="<?php echo $c['pengguna_id'];?>"/> 
                                            <div class="form-group">
                                                <label class="col-md-12">Full Name</label>
                                                <div class="col-md-12">
                                                    <input type="text" name="xnama"value="<?php echo $c['pengguna_nama'];?>" placeholder="Johnathan Doe" class="form-control form-control-line">
                                                </div>
                                            </div>
										...
										<?php endif;?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="email" name="xemail" value="<?php echo $c['pengguna_email'];?>" placeholder="johnathan@admin.com" class="form-control form-control-line" name="example-email" id="example-email">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="example-email" class="col-md-12">Username</label>
                                                <div class="col-md-12">
                                                    <input type="text" name="xusername" value="<?php echo $c['pengguna_username'];?>" placeholder="johnathan@admin.com" class="form-control form-control-line" name="example-email" id="example-email">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-12">Password</label>
                                                <div class="col-md-12">
                                                    <input type="password" name="xpassword" value="<?php echo $c['pengguna_password'];?>" class="form-control form-control-line">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-12">Phone No</label>
                                                <div class="col-md-12">
                                                    <input type="text" name="xkontak" value="<?php echo $c['pengguna_nohp'];?>" placeholder="123 456 7890" class="form-control form-control-line">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                            <input type="hidden" id="special" name="foto" class="form-control" placeholder="Foto" value="<?php echo $c['pengguna_photo'];  ?>" required>
